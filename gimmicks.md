...
Type       | Trigger
-----------|---------
Warning    |warning, achtung, attention, warnung, atenciÃ³n, guarda, advertimiento, attenzione
...
- - -
[gimmick:yuml (type: 'activity', style: 'plain') ]( `Make CoffeeÂ´->`want more coffeeÂ´ )

    [gimmick:yuml (type: 'activity', style: 'plain') ]( `Make CoffeeÂ´->`want more coffeeÂ´ )

- - -
[gimmick:yuml (type: 'usecase', scale: 150) ]( [Customer]-`Sign InÂ´, [Customer]-`Buy ProductsÂ´ )

    [gimmick:yuml (diag: 'usecase', scale: 150) ]( [Customer]-`Sign InÂ´, [Customer]-`Buy ProductsÂ´ )
